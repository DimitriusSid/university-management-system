...
<body>
    <h3>Add students to teacher ${teacher.teacherPersonalInfo.name} of the ${teacher.faculty.facultyName} faculty</h3>
    ...
    <form:form method="post" action="addStudentsToTeacher" modelAttribute="students">
        ...
        <c:forEach var="student" items="${students}">
            ...
            <label for="${student.id}">${student.studentPersonalInfo.name} of the ${student.faculty.facultyName} faculty</label>
            <br>
        </c:forEach>
